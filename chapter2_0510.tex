    ...
    \subsubsection{通信路の最高データ転送速度(pp.105-106)}
      \begin{itemize}
        ...
        \begin{itemize}
          ...
          \item 比は常に大きな範囲で変化するため，対数目盛上で$10 \log_{10} S/N$の値で表され，単位は\emph{デシベル(decibel)(dB)}である
				\end{itemize}
    ...
    \subsubsection{磁気媒体(pp.106-107)}
		...
		\subsubsection{電力線(pp.109-110)}
			\begin{itemize}
				...
				\begin{itemize}
					\item 電力信号は50〜60\si{hz}であり，電力線はデータ通信で使用するような帯域の信号を減衰させる
...
\section{補足}
	\subsection{干渉計}
		...
		\subsubsection{マッハ・ゼンダ干渉計}
			...
			\begin{figure}[H]
				\centering
				\includegraphics{mach.png}
				\caption{マッハ・ゼンダ干渉計の模式図}
			\end{figure}
				
\begin{thebibliography}{99}
	\bibitem{lan} LANケーブル - ELECOM，https://www2.elecom.co.jp/cable/lan/index.html#1，2019年5月9日閲覧
